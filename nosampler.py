...
grid = [['amazon_electronics_100000_dataset', 'amazon_electronics_100000_bert_0.95', 1.0],
        ...
        ['amazon_movies_100000_dataset', 'amazon_movies_100000_fasttext_0.3', 1.0],
        ['amazon_movies_100000_dataset', 'amazon_movies_100000_fasttext_0.6', 1.0],
        ['amazon_movies_100000_dataset', 'amazon_movies_100000_glove_0.3', 1.0],
        ['amazon_movies_100000_dataset', 'amazon_movies_100000_glove_0.6', 1.0],
...
def process_sampler(inp):
    ...
    joblib.dump(sampler, "dumps/BTM_sampler_" + embedding_name + "_" + str(lambda_param))
